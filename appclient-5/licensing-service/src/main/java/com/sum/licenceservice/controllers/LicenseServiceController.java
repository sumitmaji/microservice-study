...
public class LicenseServiceController {
    ...
    public List<License> getLicenses(@PathVariable("organizationId") String organizationId) {
        ...
        System.out.println(String.format("LicenseServiceController Correlation id: {}", UserContextHolder.getContext().getCorrelationId()));
        try {
